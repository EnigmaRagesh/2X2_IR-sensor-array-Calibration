...
(cl:defmethod cl:initialize-instance :after ((m <world_point>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'world_point)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pixart_localization-msg:<world_point> is deprecated: use pixart_localization-msg:world_point instead.")))

(cl:ensure-generic-function 'pt-val :lambda-list '(m))
(cl:defmethod pt-val ((m <world_point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pixart_localization-msg:pt-val is deprecated.  Use pixart_localization-msg:pt instead.")
  (pt m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<world_point>)))
  ...
  "pixart_localization/world_point")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'world_point)))
  "Returns string type for a message object of type 'world_point"
  "pixart_localization/world_point")
